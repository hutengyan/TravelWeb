...
<head>
    ...
    <script>
        ...
        function checkAll() {
            if(checkUserName() & checkPass() & validate()){
...
<form action="/login.user" method="post" role="form" id="form">
    <%
        if(request.getParameter("userName")!=null){
    %>
    <script>window.alert("用户名和密码错误");</script>
    <%
        }
    %>
    ...
    <input style="margin-left: 250px;margin-top: 10px" class="col-sm-1" type="button" value="提交" onclick="checkAll();">
</form>
</body>
</html>